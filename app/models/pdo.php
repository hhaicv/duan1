...
function update_client($id, $tendangnhap, $hoten, $hinhanh,$matkhau, $email, $sdt, $diachi)
{
    $sql = "UPDATE tai_khoan SET ten_dang_nhap='$tendangnhap',ho_ten='$hoten',img='$hinhanh',mat_khau='$matkhau',email='$email',sdt='$sdt',dia_chi='$diachi' WHERE id_tai_khoan = '$id'";
    pdo_execute($sql);
}
